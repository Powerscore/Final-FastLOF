"""
FastLOF Experiment - HTTP Dataset
==================================
Runs Experiment B (FastLOF vs Standard LOF) on http dataset.
"""
...
DATASET_FILEPATH = "data/http.mat"
DATASET_NAME = "http"

# Experiment parameters
K_VALUES = [10, 20, 30, 40, 50]
THRESHOLDS = [1.1, 1.2]  # List of thresholds to test
MIN_CHUNK_SIZE = 500
