"""
Original LOF Experiment - Pen Local Dataset
============================================
Runs Experiment A (Original LOF vs Single-k LOF) on pen-local-unsupervised-ad dataset.
"""
...
DATASET_NAME = "pen-local-unsupervised-ad"
