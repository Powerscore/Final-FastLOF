#!/bin/bash
#SBATCH --job-name=fastlof_annthyroid-unsupervised-ad
#SBATCH --output=slurm_logs/annthyroid-unsupervised-ad_fastlof_%j.out
#SBATCH --error=slurm_logs/annthyroid-unsupervised-ad_fastlof_%j.err
...
# ============================================================================
# FastLOF Experiment - annthyroid-unsupervised-ad
# ============================================================================
...
echo "========================================================================"
echo "Starting Experiment: annthyroid-unsupervised-ad - FastLOF"
echo "========================================================================"
echo ""
