...
echo "========================================================================"
echo "Starting Experiment: mulcross - FastLOF"
echo "========================================================================"
echo ""

python -u experiment_scripts/mulcross/run_fastlof.py 2>&1 | tee -a experiment_scripts/slurm_logs/mulcross_fastlof_live.log
