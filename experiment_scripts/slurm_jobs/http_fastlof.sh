#!/bin/bash
#SBATCH --job-name=fastlof_http
#SBATCH --output=slurm_logs/http_fastlof_%j.out
#SBATCH --error=slurm_logs/http_fastlof_%j.err
...
echo "========================================================================"
echo "Starting Experiment: http - FastLOF"
echo "========================================================================"
echo ""

python -u experiment_scripts/http/run_fastlof.py 2>&1 | tee -a experiment_scripts/slurm_logs/http_fastlof_live.log
