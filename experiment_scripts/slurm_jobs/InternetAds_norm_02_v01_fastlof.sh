#!/bin/bash
#SBATCH --job-name=fastlof_InternetAds_norm_02_v01
#SBATCH --output=slurm_logs/InternetAds_norm_02_v01_fastlof_%j.out
#SBATCH --error=slurm_logs/InternetAds_norm_02_v01_fastlof_%j.err
...
echo "========================================================================"
echo "Starting Experiment: InternetAds_norm_02_v01 - FastLOF"
echo "========================================================================"
echo ""
