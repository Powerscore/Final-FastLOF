#!/bin/bash
#SBATCH --job-name=original_lof_http
#SBATCH --output=slurm_logs/http_original_lof_%j.out
#SBATCH --error=slurm_logs/http_original_lof_%j.err
...
echo "========================================================================"
echo "Starting Experiment: http - Original LOF"
echo "========================================================================"
echo ""

python -u experiment_scripts/http/run_original_lof.py 2>&1 | tee -a experiment_scripts/slurm_logs/http_original_lof_live.log
