#!/bin/bash
#SBATCH --job-name=fastlof_ForestCover
#SBATCH --output=slurm_logs/ForestCover_fastlof_%j.out
#SBATCH --error=slurm_logs/ForestCover_fastlof_%j.err
...
# ============================================================================
# FastLOF Experiment - ForestCover
# ============================================================================
...
echo "========================================================================"
echo "Starting Experiment: ForestCover - FastLOF"
echo "========================================================================"
echo ""

python -u experiment_scripts/ForestCover/run_fastlof.py 2>&1 | tee -a experiment_scripts/slurm_logs/ForestCover_fastlof_live.log
